...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const segmentsData = [
    ...
    { value: percVazio, color: getComputedStyle(document.documentElement).classList?.contains('dark') ? '#4B5563' : '#D1D5DB' }
  ];
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const dados = [
    ...
    { dia: 'Sex', altura: 93, valor: '10%' }, // destaque
    { dia: 'Sab', altura: 80, valor: '84' },
    { dia: 'Dom', altura: 34, valor: '58' },
  ];

  /* =========================
     LOCALIZA O CARD INSIGHTS
  ========================= */
